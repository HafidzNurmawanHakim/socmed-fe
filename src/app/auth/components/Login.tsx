...
const Login = () => {
	...
	return (
		<div
			id="login"
			className={`h-screen w-screen custom-gradient-bg py-10 md:py-0`}
		>
			...
			<div className="md:flex rounded-full drop-shadow-xl w-3/4 m-auto md:pt-20">
							...
							<Form className="w-5/6 md:w-3/4 m-auto p-6 rounded-xl md:rounded-s-xl space-y-4">
								...
								<div className="relative">
									...
									<div className="absolute flex items-center text-xl top-[45%]  right-3 transform-translate-y-1/2">
										<div className={`pb-1 mr-2 ${!!values.password ? "opacity-100" : "opacity-0"}`}>
											{seePass ? (
								...
								<div className="flex justify-between items-center">
									<div className="flex items-center">
										<Field type="checkbox" id="remember" name="remember" className="checkbox" />
								...
								>
									{isSubmitting ? (
										<>
											<span className="normal-case text-dark font-normal">Loading...</span>
											<span className=" loading loading-spinner spinner-dark"></span>
										</>
									) : (
										<span className="normal-case text-white font-normal text-dark">Login</span>
									)}
								</button>
				...
				<div className="basis-1/2 bg-darker hidden md:block md:bg-login bg-right bg-cover rounded-e-xl py-20 pl-10 relative">
					...
					<div className="mt-10">
						<p>
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos blanditiis
							voluptatem harum ducimus odio sequi eaque dolorem, fugiat omnis ea eius
							adipisci? Officia, harum ullam!
						</p>
					</div>
